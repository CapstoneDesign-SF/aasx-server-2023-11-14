...
namespace AasxServer
{
    ...
    public static class Program
    {
        ...
        public static DatabaseServer localDbServer;
        public static DatabaseServer cloudDbServer;
...
#pragma warning restore 8618
        ...
        private static int Run(CommandLineArguments a)
        {
            ...
            */
            ...
            /// TODO: env 배열 내용 DB로 포워딩
            /// 역할: DB에 env 요소와 같은 AASID 존재여부 조회 후 없다면 포워딩.
            /// 231103 pmj
            /// - name of the obj for database server connection is 'dbServer'
            /// - aas data is at variable 'env'
            ...
            if (a.WithDb)
            {
                ...
                foreach (var e in env)
                {
                    ...
                    {
                        var aasEnv = e.AasEnv;
                        if (aasEnv != null && aasEnv.AssetAdministrationShells != null && aasEnv.AssetAdministrationShells.Count != 0)
                        {
                            var aass = aasEnv.AssetAdministrationShells;
        ...
        public static void Main(string[] args)
        {
            ...
            var rootCommand = new RootCommand("serve AASX packages over different interfaces")
            {
                ...
                new Option<bool>(
                    new[] {"--with-db"},
                    "If set, connect MySql database server")
            };
